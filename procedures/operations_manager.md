...
*Role: Main safety manager, enforce checklists and procedures, POC with FAR range staff.*
...
- [ ] Maintain authority for aborts: **EXECUTE ABORT COMMUNICATION IMMEDIATELY IF SAFETY COMPROMISED.**
- [ ] Maintain real-time coordination with FAR range staff as required during the burn.

## Post-Test / Debrief
- [ ] Confirm system safing parameters are met before allowing personnel return.
- [ ] Report conclusion of firing to FAR range staff.
- [ ] Lead Team Debriefing and procedure compliance review.
