# GSE Manager Checklist

*Role: Operator in charge of Ground Station (fill, pressurization, actuation, NOT ELECTRONICS), works with ECOMM/ACTCOMM to ensure sensors/actuators connect properly.*
...
- [ ] Check fluid fitting tightness throughout GSE system.
...
## Pad Closeout
- [ ] Ensure High Pressure Supply is set (K-bottle to GSE, regulator 4500 psi).
- [ ] Ensure Low Pressure Supply is set (K-bottle to GSE, regulator 150 psi).
- [ ] Verify all pneumatic hoses are physically connected (coordinated with ACTCOMM).
