...
## Setup & Testing
- [ ] Coordinate with GSE Manager for physical actuator and pneumatic line setup.
- [ ] Verify all solenoids are properly mounted and secured.
...
- [ ] Confirm commanded states match physical valve behavior.
- [ ] Verify actuation timing is nominal.
- [ ] Verify state transitions twice during dry run.
- [ ] Monitor for unintended actuation.
...
- [ ] Confirm pneumatic hoses are properly seated and secured.
- [ ] Perform final visual inspection with GSE Manager.
