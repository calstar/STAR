...
- [ ] Monitor upstream and downstream pressures continuously.
- [ ] Confirm regulator maintains stable output pressure.
- [ ] Watch for pressure oscillations, regulator creep, or rapid drops.
- [ ] Ensure supply pressure remains within expected range during pressurization.
...
- [ ] Confirm downstream gauges read zero or near-zero.
- [ ] Confirm no audible leaks remain.
- [ ] Secure bottle valve and regulator.
- [ ] **TELL GSE MANAGER HIGH PRESSURE SYSTEM IS DEPRESSURIZED AND SAFE.**