...
inline void matrix_multiply(const double* A, size_t m, size_t n, const double* B, size_t p,
                            double* C) {
...
inline void matrix_vector_multiply(const double* A, size_t m, size_t n, const double* x,
                                   double* y) {
    for (size_t i = 0; i < m; i++) {
        double sum = 0.0;
        for (size_t j = 0; j < n; j++) {
