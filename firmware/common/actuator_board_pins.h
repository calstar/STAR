...
// Actual number of actuators in use should be determined dynamically from
// config/CSV at runtime
...
inline int getActuatorPin(uint8_t actuator_id) {
    switch (actuator_id) {
        case 1:
            return Actuator_Board.ACTUATOR_1;
        case 2:
            return Actuator_Board.ACTUATOR_2;
        case 3:
            return Actuator_Board.ACTUATOR_3;
        case 4:
            return Actuator_Board.ACTUATOR_4;
        case 5:
            return Actuator_Board.ACTUATOR_5;
        case 6:
            return Actuator_Board.ACTUATOR_6;
        case 7:
            return Actuator_Board.ACTUATOR_7;
        case 8:
            return Actuator_Board.ACTUATOR_8;
        case 9:
            return Actuator_Board.ACTUATOR_9;
        case 10:
            return Actuator_Board.ACTUATOR_10;
        default:
            return -1;  // Invalid actuator ID
    }
}
...
inline int getCurrentSensePin(uint8_t actuator_id) {
    switch (actuator_id) {
        case 1:
            return Actuator_Board.CURRENT_SENSE_1;
        case 2:
            return Actuator_Board.CURRENT_SENSE_2;
        case 3:
            return Actuator_Board.CURRENT_SENSE_3;
        case 4:
            return Actuator_Board.CURRENT_SENSE_4;
        case 5:
            return Actuator_Board.CURRENT_SENSE_5;
        case 6:
            return Actuator_Board.CURRENT_SENSE_6;
        case 7:
            return Actuator_Board.CURRENT_SENSE_7;
        case 8:
            return Actuator_Board.CURRENT_SENSE_8;
        case 9:
            return Actuator_Board.CURRENT_SENSE_9;
        case 10:
            return Actuator_Board.CURRENT_SENSE_10;
        default:
            return -1;  // Invalid actuator ID
    }
}
