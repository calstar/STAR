...
inline constexpr ConnectorAdcMapEntry PT_Board_AdcEntries[] = {
    ...
    {1, 1, ADS126X_AIN0, 1},  {2, 1, ADS126X_AIN1, 1}, {3, 1, ADS126X_AIN7, 1},
    {4, 1, ADS126X_AIN5, 1},  {5, 1, ADS126X_AIN9, 1}, {6, 1, ADS126X_AIN2, 1},
    {7, 1, ADS126X_AIN3, 1},  {8, 1, ADS126X_AIN4, 1}, {9, 1, ADS126X_AIN6, 1},
    {10, 1, ADS126X_AIN8, 1},
};
...
inline constexpr ConnectorAdcMapEntry LC_Board_AdcEntries[] = {
    // connector, pin, adc channel, adc index
    {1, 1, ADS126X_AIN0, 1},  {1, 2, ADS126X_AIN1, 1}, {2, 1, ADS126X_AIN4, 1},
    {2, 2, ADS126X_AIN5, 1},  {3, 1, ADS126X_AIN8, 1}, {3, 2, ADS126X_AIN9, 1},
    {6, 1, ADS126X_AIN2, 1},  {6, 2, ADS126X_AIN3, 1}, {7, 1, ADS126X_AIN6, 1},
    {7, 2, ADS126X_AIN7, 1},

    {4, 1, ADS126X_AIN2, 2},  {4, 2, ADS126X_AIN3, 2}, {5, 1, ADS126X_AIN6, 2},
    {5, 2, ADS126X_AIN7, 2},  {8, 1, ADS126X_AIN0, 2}, {8, 2, ADS126X_AIN1, 2},
    {9, 1, ADS126X_AIN4, 2},  {9, 2, ADS126X_AIN5, 2}, {10, 1, ADS126X_AIN8, 2},
    {10, 2, ADS126X_AIN9, 2},
};
...
inline constexpr ConnectorAdcMapEntry TC_Board_AdcEntries[] = {
    // connector, pin, adc channel, adc index
    {1, 1, ADS126X_AIN0, 1},  {2, 1, ADS126X_AIN2, 1}, {3, 1, ADS126X_AIN4, 1},
    {4, 1, ADS126X_AIN6, 1},  {5, 1, ADS126X_AIN8, 1}, {6, 1, ADS126X_AIN1, 1},
    {7, 1, ADS126X_AIN3, 1},  {8, 1, ADS126X_AIN5, 1}, {9, 1, ADS126X_AIN7, 1},
    {10, 1, ADS126X_AIN9, 1},
};
...
inline constexpr const AdcLayout& AdcMap =
    ADC_LAYOUT_FROM_PINS(PINS_ACTIVE_LAYOUT);
...
constexpr int getIdacChannel(uint8_t connector, uint8_t pin) {
    ...
    // We set the pin number for the IDAC channels to be + 100 since it was the
    // cleanest way
