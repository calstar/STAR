...
// RTD board: cycle connectors 1 and 2 only. Each connector is differential (pin
// 1 vs pin 2) with IDAC excitation.
...
void set_connector_rtd(uint8_t connector_id) {
    ads126x.setInputMux(getAdcChannel(connector_id, 1),
