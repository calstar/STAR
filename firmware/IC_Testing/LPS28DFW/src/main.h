...
// 7-bit I2C: 0x5C default, 0x5D if address pin high (matches SparkFun
// LPS28DFW_I2C_ADDRESS_*)
#define LPS28DFW_I2C_ADDR 0x5C

// Reference sea-level pressure (hPa) for barometric altitude; set to local QNH
// for better accuracy
