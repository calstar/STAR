...
// ---------------------------------------------------------------------------
// Network: secondary = 192.168.2.101, listen 5006; reply to primary at
// primaryIP:5005
// ---------------------------------------------------------------------------
byte mac[6];
...
void setup() {
    ...
    SPI.begin(sense_board_pins::PT_Board.ETH_SCLK,
              sense_board_pins::PT_Board.ETH_MISO,
              sense_board_pins::PT_Board.ETH_MOSI,
              sense_board_pins::PT_Board.ETH_CS);
    delay(500);
