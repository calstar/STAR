...
struct ElodinDataPoint {
    ...
    std::string data_type;        // "raw_adc", "voltage", "pressure", "calibration_param", "variance", etc.
    double value;
...
struct CalibrationConvergenceData {
    ...
    CalibrationConvergenceData() : calibration_iteration(0), confidence_score(0.0), nrmse(0.0), coverage_95(0.0) {}
};
...
public:
     ...
     */
    void streamHumanFeedback(const std::string& sensor_id,
     ...
     */
    void createCalibrationPlot(const std::string& sensor_id,
                             const std::string& plot_title = "");
    
    /**
     * @brief Create convergence tracking plot
     */
    void createConvergencePlot(const std::string& sensor_id,
                             const std::string& plot_title = "");
    
    /**
     * @brief Create variance reduction plot
     */
    void createVariancePlot(const std::string& sensor_id,
                          const std::string& plot_title = "");
...
public:
     ...
     */
    void processCalibrationUpdate(const std::string& sensor_id,
                                const CalibrationParameters& params,
                                int iteration);
     ...
     */
    void processHumanFeedback(const std::string& sensor_id,
                            double reference_pressure,
                            double measured_voltage,
                            bool accepted);
...
private:
     ...
     */
    void updateSensorTracking(const std::string& sensor_id,
                            const CalibrationParameters& params,
                            int iteration);
