...
inline std::mutex* get_pt_message_lock(uint8_t sensor_id) {
    switch (sensor_id) {
        case 0: return &PT_MESSAGE_0_LOCK;
        case 1: return &PT_MESSAGE_1_LOCK;
        case 2: return &PT_MESSAGE_2_LOCK;
        case 3: return &PT_MESSAGE_3_LOCK;
        case 4: return &PT_MESSAGE_4_LOCK;
        case 5: return &PT_MESSAGE_5_LOCK;
        case 6: return &PT_MESSAGE_6_LOCK;
        case 7: return &PT_MESSAGE_7_LOCK;
...
inline mfPTMessage* get_pt_message(uint8_t sensor_id) {
    switch (sensor_id) {
        case 0: return &pt_message_0;
        case 1: return &pt_message_1;
        case 2: return &pt_message_2;
        case 3: return &pt_message_3;
        case 4: return &pt_message_4;
        case 5: return &pt_message_5;
        case 6: return &pt_message_6;
        case 7: return &pt_message_7;
        default: return nullptr;
    }
}
...
inline std::mutex* get_tc_message_lock(uint8_t sensor_id) {
    switch (sensor_id) {
        case 0: return &TC_MESSAGE_0_LOCK;
        case 1: return &TC_MESSAGE_1_LOCK;
        case 2: return &TC_MESSAGE_2_LOCK;
        case 3: return &TC_MESSAGE_3_LOCK;
        default: return nullptr;
    }
}
...
inline mfTCMessage* get_tc_message(uint8_t sensor_id) {
    switch (sensor_id) {
        case 0: return &tc_message_0;
        case 1: return &tc_message_1;
        case 2: return &tc_message_2;
        case 3: return &tc_message_3;
        default: return nullptr;
    }
}
...
inline std::mutex* get_rtd_message_lock(uint8_t sensor_id) {
    switch (sensor_id) {
        case 0: return &RTD_MESSAGE_0_LOCK;
        case 1: return &RTD_MESSAGE_1_LOCK;
        case 2: return &RTD_MESSAGE_2_LOCK;
        case 3: return &RTD_MESSAGE_3_LOCK;
        default: return nullptr;
    }
}
...
inline mfRTDMessage* get_rtd_message(uint8_t sensor_id) {
    switch (sensor_id) {
        case 0: return &rtd_message_0;
        case 1: return &rtd_message_1;
        case 2: return &rtd_message_2;
        case 3: return &rtd_message_3;
        default: return nullptr;
    }
}
...
inline std::mutex* get_lc_message_lock(uint8_t sensor_id) {
    switch (sensor_id) {
        case 0: return &LC_MESSAGE_0_LOCK;
        case 1: return &LC_MESSAGE_1_LOCK;
        case 2: return &LC_MESSAGE_2_LOCK;
        case 3: return &LC_MESSAGE_3_LOCK;
        default: return nullptr;
    }
}
...
inline mfLCMessage* get_lc_message(uint8_t sensor_id) {
    switch (sensor_id) {
        case 0: return &lc_message_0;
        case 1: return &lc_message_1;
        case 2: return &lc_message_2;
        case 3: return &lc_message_3;
        default: return nullptr;
    }
}
