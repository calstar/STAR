...
public:
    ...
    // Direct state access
    double getAltitude() const { return state_.altitude_m; }
    double getVerticalVelocity() const { return state_.vertical_velocity_ms; }
    double getThrust() const { return state_.thrust_n; }
    double getStateQuality() const { return state_.state_quality; }
