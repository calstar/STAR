...
inline bool weighted_least_squares(const double* X, size_t m, size_t n, const double* y,
                                   const double* W_diag, double* beta) {
    // Allocate workspace
...
inline bool regularized_weighted_least_squares(const double* X, size_t m, size_t n, const double* y,
                                               const double* W_diag, double lambda, double* beta) {
    // Allocate workspace
    double* XTWX = new double[n * n];
    double* XTWy = new double[n];
