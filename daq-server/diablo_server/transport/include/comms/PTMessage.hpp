 ...
 */
using PTMessage = comms::CommsMessage<uint8_t,    // (0) ch - channel id
                                      uint8_t,    // (1) ok - 0 or 1
...
static std::string getPTLocationName(PTLocation location) {
    switch (location) {
        case PTLocation::PRESSURANT_TANK:
            return "Pressurant Tank";
        case PTLocation::KERO_INLET:
            return "Kero Inlet";
        case PTLocation::KERO_OUTLET:
            return "Kero Outlet";
        case PTLocation::LOX_INLET:
            return "Lox Inlet";
        case PTLocation::LOX_OUTLET:
            return "Lox Outlet";
        case PTLocation::INJECTOR:
            return "Injector";
        case PTLocation::CHAMBER_WALL_1:
            return "Chamber Wall #1";
        case PTLocation::CHAMBER_WALL_2:
            return "Chamber Wall #2";
        case PTLocation::NOZZLE_EXIT:
            return "Nozzle Exit";
        case PTLocation::UNKNOWN:
            return "Unknown";
        default:
            return "Invalid";
    }
