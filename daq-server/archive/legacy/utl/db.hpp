#ifndef ELODIN_DB_HPP
#define ELODIN_DB_HPP
...
/// that length is not greater than the size of the array. *Side Effects /
...
postcard_error_t postcard_encode_byte_array(postcard_slice_t* slice, const uint8_t* bytes,
                                            size_t length);
...
/// that length is not greater than the size of the string. *Side Effects /
/// Returns* If there is not enough room in the buffer `postcard_error_t` will
/// return a non-zero value If encoding was successful, slice.len will be
/// incremented by the number of encoded bytes
...
/// decoded bytes
postcard_error_t postcard_decode_byte_array(postcard_slice_t* slice, uint8_t* bytes,
...
/// decoding was successful, slice.len will be incremented by the number of
/// decoded bytes
postcard_error_t postcard_decode_string(postcard_slice_t* slice, char* string, size_t max_length,
...
/// tag *Side Effects / Returns* If there is not enough room in the buffer
...
inline static postcard_error_t encode_unsigned_varint(postcard_slice_t* slice, uint64_t value,
                                                      size_t max_bytes) {
    if (!slice || !slice->data)
...
inline static postcard_error_t encode_signed_varint(postcard_slice_t* slice, int64_t value,
                                                    size_t max_bytes) {
...
inline static postcard_error_t decode_unsigned_varint(postcard_slice_t* slice, uint64_t* value,
                                                      size_t max_bytes) {
...
inline static postcard_error_t decode_signed_varint(postcard_slice_t* slice, int64_t* value,
                                                    size_t max_bytes) {
    uint64_t zigzag;
...
inline postcard_error_t postcard_encode_byte_array(postcard_slice_t* slice, const uint8_t* bytes,
                                                   size_t length) {
...
inline postcard_error_t postcard_encode_string(postcard_slice_t* slice, const char* string,
                                               size_t length) {
...
public:
    ...
    size_t encoded_size() const {
        ...
        if ([[maybe_unused]] auto val = std::get_if<0>(
                (const std::variant<std::monostate, std::monostate, int64_t>*)this)) {
    ...
    postcard_error_t encode_raw(postcard_slice_t* slice) const {
        ...
        if ([[maybe_unused]] auto val =
                std::get_if<0>((std::variant<std::monostate, std::monostate, int64_t>*)this)) {
            ...
            if (result != POSTCARD_SUCCESS)
                return result;
                       ...
                       (std::variant<std::monostate, std::monostate, int64_t>*)this)) {
...
struct FixedRateBehavior {
    ...
    postcard_error_t encode_raw(postcard_slice_t* slice) const {
        ...
        if (result != POSTCARD_SUCCESS)
            return result;
        if (timestep) {
            result = postcard_encode_option_some(slice);
            if (result != POSTCARD_SUCCESS)
                return result;
...
public:
    ...
    size_t encoded_size() const {
        ...
        if ([[maybe_unused]] auto val =
                std::get_if<0>((const std::variant<std::monostate, FixedRateBehavior>*)this)) {
        } else if ([[maybe_unused]] auto val = std::get_if<1>(
                       (const std::variant<std::monostate, FixedRateBehavior>*)this)) {
    ...
    postcard_error_t encode_raw(postcard_slice_t* slice) const {
        ...
        if ([[maybe_unused]] auto val =
                std::get_if<0>((std::variant<std::monostate, FixedRateBehavior>*)this)) {
            result = postcard_encode_u8(slice, 0);
            if (result != POSTCARD_SUCCESS)
                return result;
            ...
            if (result != POSTCARD_SUCCESS)
                return result;
                       ...
                       std::get_if<1>((std::variant<std::monostate, FixedRateBehavior>*)this)) {
            result = postcard_encode_u8(slice, 1);
            if (result != POSTCARD_SUCCESS)
                return result;
...
class PrimType : public std::variant<std::monostate, std::monostate, std::monostate, std::monostate,
                                     std::monostate, std::monostate, std::monostate, std::monostate,
                                     std::monostate, std::monostate, std::monostate> {
public:
    static constexpr std::string_view TYPE_NAME = "PrimType";
    // Inherit constructors from std::variant
    using std::variant<std::monostate, std::monostate, std::monostate, std::monostate,
                       std::monostate, std::monostate, std::monostate, std::monostate,
                       std::monostate, std::monostate, std::monostate>::variant;
    ...
    const std::monostate* get_u_8() const {
        return std::get_if<0>(
            (const std::variant<std::monostate, std::monostate, std::monostate, std::monostate,
                                std::monostate, std::monostate, std::monostate, std::monostate,
                                std::monostate, std::monostate, std::monostate>*)this);
    }

    std::monostate* get_u_8() {
        return std::get_if<0>(
            (std::variant<std::monostate, std::monostate, std::monostate, std::monostate,
                          std::monostate, std::monostate, std::monostate, std::monostate,
                          std::monostate, std::monostate, std::monostate>*)this);
    }
    ...
    size_t encoded_size() const {
        ...
        if ([[maybe_unused]] auto val = std::get_if<0>(
                (const std::variant<std::monostate, std::monostate, std::monostate, std::monostate,
                       ...
                       (const std::variant<std::monostate, std::monostate, std::monostate,
                                           std::monostate, std::monostate, std::monostate,
                                           std::monostate, std::monostate, std::monostate,
                                           std::monostate, std::monostate>*)this)) {
        } else if ([[maybe_unused]] auto val = std::get_if<2>(
                       (const std::variant<std::monostate, std::monostate, std::monostate,
                                           std::monostate, std::monostate, std::monostate,
                                           std::monostate, std::monostate, std::monostate,
                       ...
                       (const std::variant<std::monostate, std::monostate, std::monostate,
                                           ...
                                           std::monostate, std::monostate, std::monostate,
                                           std::monostate, std::monostate>*)this)) {
        } else if ([[maybe_unused]] auto val = std::get_if<7>(
                       (const std::variant<std::monostate, std::monostate, std::monostate,
                                           std::monostate, std::monostate, std::monostate,
                                           std::monostate, std::monostate, std::monostate,
                                           std::monostate, std::monostate>*)this)) {
        } else if ([[maybe_unused]] auto val = std::get_if<8>(
                       (const std::variant<std::monostate, std::monostate, std::monostate,
                                           std::monostate, std::monostate, std::monostate,
                                           std::monostate, std::monostate, std::monostate,
                                           std::monostate, std::monostate>*)this)) {
        } else if ([[maybe_unused]] auto val = std::get_if<9>(
                       (const std::variant<std::monostate, std::monostate, std::monostate,
                                           std::monostate, std::monostate, std::monostate,
                                           std::monostate, std::monostate, std::monostate,
                                           std::monostate, std::monostate>*)this)) {
        } else if ([[maybe_unused]] auto val = std::get_if<10>(
                       (const std::variant<std::monostate, std::monostate, std::monostate,
                                           std::monostate, std::monostate, std::monostate,
                                           std::monostate, std::monostate, std::monostate,
                                           std::monostate, std::monostate>*)this)) {
...
inline SetComponentMetadata set_component_name(std::string name) {
...
inline SetEntityMetadata set_entity_name(uint64_t entity_id, std::string name) {
...
public:
    ...
    explicit OpBuilder(const Table& table) : value(table) {
    }

    explicit OpBuilder(const Pair& pair) : value(pair) {
    }

    explicit OpBuilder(const Schema& schema) : value(schema) {
    }
...
public:
    ...
    FieldBuilder(uint16_t offset, uint16_t len, std::shared_ptr<OpBuilder> arg)
        : offset(offset), len(len), arg(std::move(arg)) {
    }
};
...
/// Creates a schema operation builder from a primitive type, dimensions, and an
/// argument
inline std::shared_ptr<OpBuilder> schema(PrimType ty, const std::vector<uint64_t>& dim,
                                         std::shared_ptr<OpBuilder> arg) {
...
/// Creates a timestamp operation builder from a timestamp source and an
/// argument
inline std::shared_ptr<OpBuilder> timestamp(std::shared_ptr<OpBuilder> timestamp,
                                            std::shared_ptr<OpBuilder> arg) {
 ...
 * argument
 */
inline std::shared_ptr<OpBuilder> ext(std::tuple<uint8_t, uint8_t> id,
                                      std::shared_ptr<OpBuilder> data,
                                      std::shared_ptr<OpBuilder> arg) {
...
/// ## Usage
/// ```cpp
///  builder::field<Foo, &Foo::time>(builder::schema(PrimType::F64(), {},
///  builder::pair(1, "time"))),
/// ```
...
public:
    ...
    /// Visits an operation builder, adding it to the VTable and returning its
    /// OpRef
        ...
        std::visit(
            [&](const auto& val) {
                ...
                if constexpr (std::is_same_v<T, OpBuilder::Data>) {
                    ...
                    result_op = Op::Schema(OpSchema{static_cast<uint16_t>(ty.value),
                    ...
                    result_op = Op::Timestamp(OpTimestamp{static_cast<uint16_t>(timestamp.value),
                                                          static_cast<uint16_t>(arg.value)});
    ...
    void push_field(const FieldBuilder& field_builder) {
        ...
        Field field{field_builder.offset, field_builder.len, static_cast<uint16_t>(arg.value)};
...
#define TABLE(type, field)                                                   \
    vtable::builder::raw_table(static_cast<uint16_t>(offsetof(type, field)), \
...
#define FIELD(type, field, arg)                                              \
    vtable::builder::raw_field(static_cast<uint16_t>(offsetof(type, field)), \
                               static_cast<uint16_t>(sizeof(((type*)nullptr)->field)), arg)
