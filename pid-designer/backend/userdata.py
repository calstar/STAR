"""Per-user data storage for the P&ID Designer.
...
# No list_configs/read_config/...: the older named-config library is an
# EngineDesign/recovery-calculator feature that pid-designer never had.
