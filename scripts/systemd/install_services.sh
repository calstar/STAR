...
echo "  systemctl --user start sensor-relay sensor-backend sensor-frontend sensor-sidecar"
echo ""
echo "Or start all:"
echo "  systemctl --user start sensor-elodin sensor-daq sensor-simulator sensor-relay sensor-backend sensor-frontend sensor-sidecar"
echo ""
echo "To enable on boot:"
echo "  systemctl --user enable sensor-elodin sensor-daq sensor-simulator sensor-relay sensor-backend sensor-frontend sensor-sidecar"
echo ""
