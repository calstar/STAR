...
#: The ``<app>`` path segment for this backend. Distinct per app, so star-openrocket
#: and the recovery calculator (merging in soon) keep separate trees under one user.
APP = "openrocket"
