...
const FIELD_LABELS: Record<string, string> = {
  ...
  K: 'Legacy Evaporation Constant (s/m²) — reciprocal of k_evap',
  x_star_limit: 'Max Evaporation Length (m)',
  use_constraint: 'Enforce Evaporation Length Limit',
  chamber_gas_R: 'Chamber Gas R (J/kg·K)',
  chamber_gas_T: 'Chamber Gas Temperature (K)',
  C_ingebo: 'Ingebo SMD Prefactor',
  layer1_impingement_Ld_min: 'Impingement Distance Min (orifice diameters)',
  layer1_impingement_Ld_max: 'Impingement Distance Max (orifice diameters)',
  // Layer-1 objective knobs. These are weights and tolerances on the optimizer's own
  // objective, not physical dimensions -- name them so the generic editor does not show
  // raw snake_case keys for the things that decide whether a run "converges".
  layer1_W_EXIT: 'Weight: Exit Pressure',
  layer1_exit_pressure_deadband_rel: 'Exit Pressure Deadband (rel, e.g. 0.002 = ±0.2%)',
  layer1_W_LSTAR: 'Weight: L* Above Target',
  layer1_Lstar_target_m: 'L* Target (m) — above this starts costing',
  layer1_tank_equal_tol_psi: 'Tank Match Tolerance (psi) — free below this',
  layer1_integer_jet_angles: 'Whole-Degree Jet Angles (doublets)',
  layer1_ring_order_fuel_outboard: 'Fuel Ring Outboard of LOX Ring',
  layer1_resultant_tilt_max_deg: 'Max Outward Spray Tilt (deg; ablative guard)',
  layer1_resultant_tilt_scale_deg: 'Spray Tilt Violation Scale (deg)',
  layer1_resultant_tilt_gate_tol_deg: 'Spray Tilt Gate Tolerance (deg)',
  layer1_momentum_wall_side_multiplier: 'Momentum Miss Penalty — Wall Side Multiplier',
  layer1_momentum_scale: 'Momentum Ratio Deviation Scale',
  layer1_momentum_gate_safe_slack: 'Momentum Gate — Safe-Side Slack',
  layer1_Lstar_from_smd: 'Derive L* Target from Spray SMD (d²-law)',
  layer1_Lstar_smd_ref_um: 'L* Correlation — SMD Anchor (µm)',
  layer1_Lstar_ref_m: 'L* Correlation — L* at Anchor (m)',
  layer1_Lstar_smd_exponent: 'L* Correlation Exponent (2.0 = d²-law)',
  layer1_Lstar_deadband_m: 'L* Free Window Width (m)',
  layer1_impingement_Ld_target: 'Impingement Distance (jet diameters from face)',
  layer1_impingement_Ld_tol: 'Impingement Distance Tolerance (only if not derived)',
  layer1_derive_impingement_spacing: 'Solve Fuel Ring Pitch for Exact Impingement Distance',
  layer1_enforce_ring_geometry: 'Enforce Injector Ring Geometry (fit / spacing / standoff)',
  layer1_tank_equal_inband_frac: 'Tank Match In-Band Pull (fraction)',
  layer1_lock_tank_pressures: 'Lock Fuel Tank Pressure to LOX (one variable)',
  layer1_thrust_deadband_rel: 'Thrust Deadband (rel; 0.1% when throat is solved)',
  layer1_derive_tank_from_dp_ratio: 'Solve Tank Pressure from ΔP/Pc Target (experimental)',
  layer1_dp_ratio_target: 'ΔP/Pc Target for Tank Solve',
  layer1_derive_fuel_jet_from_of: 'Solve Fuel Jet from O/F Target (experimental)',
  layer1_derive_expansion_ratio: 'Solve Expansion Ratio (expand exactly to ambient)',
  layer1_derive_throat_from_thrust: 'Solve Throat Area (hit thrust target exactly)',
  layer1_derive_max_iters: 'Derived-DOF Solve Iterations (per candidate)',
  layer1_derive_thrust_tol_rel: 'Derived Throat Thrust Tolerance (relative)',
  layer1_of_deadband_rel: 'O/F Deadband (rel, e.g. 0.02 = ±2%)',
  layer1_tank_equal_scale_psi: 'Tank Match Scale (psi)',
  ...
  layer1_impinging_n_doublets_max: 'Max Doublets',
  W_IMP_GEOM: 'Weight: Injector Ring Geometry',
  W_MOM: 'Weight: Momentum Ratio',
  W_TANK_EQUAL: 'Weight: Tank Pressure Match',
  ...
  simplified_oxidation_rate: 'Simplified Oxidation Rate (m/s)',
  sizing_recession_rate: 'Sizing Recession Rate (m/s)',
  axial_half_length_ratio: 'Insert Half-Length / Throat Dia',
  axial_half_length: 'Insert Half-Length (m)',
