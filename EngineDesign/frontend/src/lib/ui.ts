/**
 * Non-component UI bits: the button class strings and one date formatter.
 *
 * Separate from components/ui.tsx purely because react-refresh requires a file
 * exporting a component to export nothing else -- mixing the two breaks fast
 * refresh for every consumer.
 */
