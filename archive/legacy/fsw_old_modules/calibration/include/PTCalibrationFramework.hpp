...
private:
    ...
    double computeBasisFunctionDerivative(int k, double voltage,
...
private:
    double computeRobustBasisFunction(int k, double voltage,
                                      const EnvironmentalState& environment) const;
    double computeRobustBasisFunctionDerivative(int k, double voltage,
                                                const EnvironmentalState& environment) const;
};
...
public:
    ...
    CalibrationParameters performBayesianCalibration(
        ...
        const Eigen::MatrixXd& population_prior_covariance, double individual_variance = 1.0);
     ...
     * @return Calibration parameters with uncertainty
     */
    CalibrationParameters performSinglePointCalibration(double zero_voltage, double zero_pressure,
                                                        const EnvironmentalState& environment);
     ...
     */
    std::pair<double, double> predictPressure(double voltage,
                                              const EnvironmentalState& environment) const;
     ...
     */
    const CalibrationParameters& getCalibrationParameters() const {
        return current_calibration_;
    }
     ...
     */
    const EnvironmentalVarianceModel& getEnvironmentalVarianceModel() const {
     ...
     */
    void setEnvironmentalVarianceModel(const EnvironmentalVarianceModel& model) {
        variance_model_ = model;
    }
     ...
     */
    size_t getNumCalibrationPoints() const {
        return calibration_data_.size();
    }
...
private:
     ...
     */
    double computeExtrapolationUncertainty(double voltage,
                                           const EnvironmentalState& environment) const;
