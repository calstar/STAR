...
export type ProjectViewMode = "board" | "list" | "gantt";

// The project board/list/timeline body. Rendered both as the project page and as
// the backdrop behind a task modal (so reloading a task URL shows the board with
// the popup on top — the same thing you saw before the reload).
