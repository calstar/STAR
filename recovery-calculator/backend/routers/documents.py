"""Per-user recovery configs with sharing, microversion history and releases.
...
store = DesignStore(
    ...
    noun="config",
    default_slug="config",
    # Seconds between automatic microversion snapshots for one config while it
...
router = make_router(store, prefix="/api/recovery/documents")
