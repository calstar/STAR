...
python3 tools/calibration/autonomous_pt_calibration.py \
...
- DAQ bridge (auto-loads from `tools/calibration/calibrations/`)
...
3. Both save to the same directory: `tools/calibration/calibrations/`
...
- Check write permissions: `tools/calibration/calibrations/`
