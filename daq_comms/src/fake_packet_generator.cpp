...
constexpr uint8_t ENCRYPTION_KEY[16] = {
...
struct UDPSender {
    ...
    bool is_valid() const { return sock >= 0; }
};
...
int main(int argc, char* argv[]) {
    ...
    while (true) {
        ...
        for (uint8_t ch = 0; ch < 3; ++ch) {
            ...
            pt.status_flags = 0;
            sensor_samples.insert(sensor_samples.end(), 
